...
(function() {
  ...
  root.Etmodel = (function() {
    function Etmodel(base, options) {
      ...
      this.inputs = $('[data-etm-input]', this.base).bind('change', (function(_this) {
        return function() {
          return _this.update();
        };
      })(this));
  ...
  root.ApiGateway = (function() {
    ...
    ApiGateway.prototype.ensure_id = function() {
      ...
      if (id = this.scenario_id) {
        ...
        this.deferred_scenario_id.done((function(_this) {
          return function(id) {
    ...
    ApiGateway.prototype.create_or_resume_scenario = function() {
      if (this.deferred_scenario) {
        ...
        return this.deferred_scenario.done((function(_this) {
    ...
    ApiGateway.prototype.changeScenario = function(_arg) {
      ...
      return this.ensure_id().done((function(_this) {
        return function(id) {
          var url;
    ...
    ApiGateway.prototype.user_values = function(_arg) {
      var error, extras, success;
      success = _arg.success, error = _arg.error, extras = _arg.extras;
      return this.ensure_id().done((function(_this) {
        return function() {
          return $.ajax({
